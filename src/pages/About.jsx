    ...
    <>
      ...
      <div className="hero about-hero">
        <div className="hero-content">
          <p className="section-title" style={{ color: '#8b4513' }}>WHO WE ARE</p>
          <h1 className="hero-title">About <br />StyleHub</h1>
          <p className="hero-sub">Fashion is not just clothing — it's a statement.<br />We help you make yours.</p>
        </div>
      </div>
      ...
      <div className="section-pad bg-white">
        ...
        <div className="two-col">
          <img src="/image/home/homeback.jpg" alt="Our Story" className="two-col-img" />
          <div>
            <p className="body-text">StyleHub was founded with a simple belief — everyone deserves to look and feel their best. What started as a small boutique has grown into a destination for fashion lovers across the country.</p>
            <p className="body-text">We curate timeless pieces and modern trends for men, women, kids, and babies — all under one roof. Quality, comfort, and style are at the heart of everything we do.</p>
          </div>
        </div>
      </div>
      ...
      <div className="section-pad bg-white" style={{ textAlign: 'center' }}>
        ...
        <form onSubmit={handleSubscribe} className="newsletter-form">
          <input value={email} onChange={e => setEmail(e.target.value)} placeholder="Enter your email" className="newsletter-input" />
